...
niches = list(
  "young_niche" = list(
    "sender" = c("Neutrophils_young", "Monocytes_young", "Macrophages_young"),
    "receiver" = c("Neuroendocrine_young")
  ),
  "old_niche" = list(
    "sender" = c("Neutrophils_adult", "Monocytes_adult", "Macrophages_adult"),
...
write.csv(data.frame(gene = geneset_NEyoung), "nichenet_targets_young.csv", row.names = FALSE)
write.csv(data.frame(gene = geneset_NEadult), "nichenet_targets_adult.csv", row.names = FALSE)

# 2. MAIN PRIORITIZATION TABLES (All ligand-receptor data)
write.csv(prioritization_tables$prioritization_tbl_ligand_receptor, 
          "nichenet_ligand_receptor_prioritization.csv", row.names = FALSE)

# 3. LIGAND-TARGET RELATIONSHIPS (All ligand-target data)  
write.csv(prioritization_tables$prioritization_tbl_ligand_target, 
          "nichenet_ligand_target_prioritization.csv", row.names = FALSE)
