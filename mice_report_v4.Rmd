...
dittoBoxPlot(malig_cells, 'Mycn', color.panel=my_colors, group.by='RNA_snn_res.0.2', jitter.size = NA)
```
...
dittoBoxPlot(malig_cells, c('Cd274', 'Psmb9', 'Psmb8', 'B2m', 'H2-Q7', 'Tgfb1'), color.panel=my_colors, group.by='RNA_snn_res.0.2', jitter.size = NA)
```
...
```{r}
dittoBoxPlot(malig_cells, c('Esr1', 'Col8a1'), color.panel=c("#FF69B4FF", "#6495EDFF"), group.by='age', jitter.size = NA)

FeaturePlot(malig_cells, c('Esr1', 'Col8a1'))
```
